        ...
        <TableBody>
          {convertedExpenses.length === 0 ? (
            ...
            convertedExpenses.map((expense) => (
              ...
              >
                <TableCell className="font-medium">{expense.description || expense.approvalSubject || 'No description'}</TableCell>
                <TableCell>{expense.employee?.name || expense.paidBy || 'N/A'}</TableCell>
